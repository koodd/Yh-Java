...
<body>
	...
	<section>
		...
		<c:if test="${map.nDto.page>1}">
			...
			<a	href="board_user?bc_no=2&page=${map.nDto.page-1}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><li class="prev"></li></a>
		</c:if>
		...
		<c:if test="${map.nDto.page<map.nDto.maxpage}">
			<a href="board_user?bc_no=2&page=${map.nDto.page+1}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><li class="next"></li></a>
		</c:if>
		<c:if test="${map.nDto.page>=map.nDto.maxpage}">
			<li class="next"></li>
		</c:if>
		<a href="board_user?bc_no=2&page=${map.nDto.maxpage}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><li class="last"></li></a>
	</ul>
